...
export default function Index() {
  return (
    ...
    //   <div dir="rtl" className="navbar bg-neutral text-neutral-content">
    //     <div className="flex-1">
    //       <a className="btn btn-ghost text-xl">ارسال العلم لاخواننا في غزة</a>
    //     </div>
    ...
    //     <div className="modal text-slate-700" role="dialog">
    ...
    //   </div>
    //   <div className=" mt-6 ">
    //     <h2 className="text-slate-800 font-mono text-lg text-center">
    //       CH.1: Fractions
    //     </h2>
